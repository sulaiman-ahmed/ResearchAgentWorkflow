...
# Build a synchronous URL for Alembic from settings.
# psycopg v3 supports sync connections via postgresql+psycopg.
# Replace the async variant if present.
_sync_url = settings.database_url.replace("postgresql+psycopg_async", "postgresql+psycopg")
